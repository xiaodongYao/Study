...
const float DEG2RAD = 3.141593f / 180.0f; //角度转弧度
const float RAD2DEG = 180.0f / 3.141593f; //弧度转角度
const float EPSILON = 0.00001f; //误差


///////////////////////////////////////////////////////////////////////////////
//transpose 2x2 matrix  //转置
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//return the determinant of 2x2 matrix //行列式
///////////////////////////////////////////////////////////////////////////////
...
{
	//angel between -pi ~ +pi (-180 ~ +180)
	return atan2f(m[1], m[0]) * RAD2DEG;
}
...
Vector3 Matrix3::getAngle() const
{
	...
	//find roll (aroud z-axis) and pitch (around x-axis)
	//if forward vector is (1,0,0) or (-1,0,0), then m[0]=m[4]=m[9]=m[10]=0
	if (m[0] > -EPSILON && m[0] < EPSILON)
	{
		roll = 0;
		pitch = atan2f(m[1], m[4]) * RAD2DEG;
	}
	else
	{
		roll = atan2f(-m[3], m[0]) * RAD2DEG;
		pitch = atan2f(-m[7], m[8]) * RAD2DEG;
	}
...
// 调用这个方法之前，必须检查det(A)是否为0，如果为0，则使用invertGeneric()方法
///////////////////////////////////////////////////////////////////////////////
Matrix4& Matrix4::invertProjective()
{
	...
	// NOTE: this function assumes det(A) is already checked. if |A|=0 then,cannot use this function.
	//float determinant = dcab.getDeterminant();
...
///////////////////////////////////////////////////////////////////////////////
// compute the inverse of a general 4x4 matrix using Cramer's Rule(克莱姆规则)
...
///////////////////////////////////////////////////////////////////////////////
float Matrix4::getCofactor(float m0, float m1, float m2, float m3, float m4, float m5, float m6, float m7, float m8) const
{
...
///////////////////////////////////////////////////////////////////////////////
//translate thie matrix by(x,y,z)
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//build a rotation matrix with given angle(degree) and rotation axis, then multiply with this object
///////////////////////////////////////////////////////////////////////////////
...
Matrix4& Matrix4::lookAt(const Vector3& target, const Vector3& up)
{
	...
	// re-compute up vector
	Vector3 newUp = forward.cross(left);
	newUp.Normalize();

	// NOTE: overwrite rotation and scale info of the current matrix
	this->setColumn(0, left);
	this->setColumn(1, newUp);
	this->setColumn(2, forward);
	return *this;
}
